...
7. Treat the 1,600-pixel delivered file as the full-resolution web image: visitors can enlarge the current carousel view in the in-page gallery overlay, so inspect the entire frame at that size.
